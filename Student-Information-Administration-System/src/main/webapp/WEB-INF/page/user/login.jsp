        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <div class="layui-form-item">
                ...
                <input type="text" name="username" id="LAY-user-login-username" lay-verify="required"
                       placeholder="学号 / 工号" class="layui-input">
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs5">
                        <div id="v_container" style="margin-left: 10px;width: 130px;height: 36px;"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit" id="my_button">
                    登录
                </button>
            </div>
            <div class="layui-trans layui-form-item layadmin-user-login-other">
                ...
                <a href="${ctx}/reg" class="layadmin-user-jump-change layadmin-link" style="margin-right: 0;">注册帐号</a>
            </div>
        </div>
    </div>

    <div class="layui-trans layadmin-user-login-footer">
        <p>© 2019<a href="https://github.com/kfoolish/UIMS/blob/master/LICENSE" target="_blank">MIT License</a></p>
    </div>
</div>
